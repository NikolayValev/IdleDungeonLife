/**
 * HTML report generator for balance test results
 * Creates interactive visualizations of balance metrics
 */
import type { BalanceRunStats } from "./balance-runner";
...
export function generateBalanceReport(
  results: BalanceRunStats[],
  title: string = "Balance Test Report"
): string {
...
function generateProfileCard(result: BalanceRunStats): string {
...
function generateComparison(_results: BalanceRunStats[]): string {
  return `
...
function generateChartScripts(results: BalanceRunStats[]): string {
  return `
